...
SCENE_NAME = MODEL_NAME = "ConcreteCatStatue"
ASSET_PATH = WORKSPACE_PATH + "assets/" + "ConcreteCatStatue" + "/"
SCENE_CONTEXT_PATH = WORKSPACE_PATH + "scenes/" + SCENE_NAME + "/"

OBJ_FILENAME = "ConcreteCatStatue.obj"
...
if __name__ == "__main__":
    ...
    mat_name = "concrete_cat_statue"
    mat_library[mat_name]["textures"]["roughness_map"] = "concrete_cat_statue_rough_2k.jpg"
    mat_library[mat_name]["textures"]["metallic_map"] = "concrete_cat_statue_metal_2k.jpg"
    mat_library[mat_name]["textures"]["ao_map"] = "concrete_cat_statue_ao_2k.jpg"
