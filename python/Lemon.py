...
SCENE_NAME = MODEL_NAME = "Lemon"
ASSET_PATH = WORKSPACE_PATH + "assets/" + "Lemon" + "/"
SCENE_CONTEXT_PATH = WORKSPACE_PATH + "scenes/" + SCENE_NAME + "/"

OBJ_FILENAME = "Lemon.obj"
...
if __name__ == "__main__":
    ...
    mat_name = "lemon"
    mat_library[mat_name]["textures"]["roughness_map"] = "lemon_rough_2k.jpg"
    mat_library[mat_name]["textures"]["metallic_map"] = None
    mat_library[mat_name]["textures"]["ao_map"] = "lemon_ao_2k.jpg"
